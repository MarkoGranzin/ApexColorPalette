var colorselector = (function () {
    ...
    var colorpalette = {
        picker: {
            show: function (jsonData, pItemID) {
                try {
                    ...
                    $.each(jsonData, function (index, value) {
                        $("#matDesignColors").append('<div class="circle pre" style ="background-color:' + value.hex + '">&nbsp;</div>');
                        // on click with color for selection
                        $("#matDesignColors").children().last().on("click", function (event) {
                            if (value.hasOwnProperty('shades')) {
                                ...
                                $.each(value.shades, function (index, value) {
                                    $("#matDesignColors").append('<div class="circle" style ="background-color:' + value.hex + '">&nbsp;</div>');
                                    $("#matDesignColors").children().last().on("click", function (event) {
                        ...
                        $("#" + pItemID).on("blur", function (e) {
                            if ($("#matDesignColors").data("bluractive")) {
                                ...
                                // reset with last existing value
                                colorpalette.picker.setColor(pItemID, currentColor);
            ...
            setColor: function (pItemID, bgColor) {
    ...
    return {
        ...
        initialize: function (
            ...
            try {
                ...
                var heightContainer = inputContainer.closest('.t-Form-itemWrapper').height();
                ...
                function setInputColor(bgColor) {
                    ...
                    if (isOk) {
                        ...
                        colorpalette.picker.setColor(pItemID, '#FFFFFF');
                    }
                }
            } catch (e) {
                util.debug.error('Error while try to show colors');
